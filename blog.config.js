...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是一个程序员, Hi，我是一个自由者,Hi，我是一个电气者,欢迎来到我的博客🎉',
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://zephyrboy.lol', // 网站地址
